"""
Django settings for fandom_site project.
...
SECRET_KEY = 'django-insecure-%hnh++h04p4yc41#fg-s@k11186^*mp6_(_lfsu0_xl=!6407a'
...
WSGI_APPLICATION = 'fandom_site.wsgi.application'
